...
- (void)tableView:(nonnull CKJSimpleTableView *)tableView commitEditingStyle:(UITableViewCellEditingStyle)editingStyle forRowAtIndexPath:(nonnull NSIndexPath *)indexPath section:(NSInteger)section row:(NSInteger)row model:(nonnull __kindof CKJCommonCellModel *)model cell:(nonnull __kindof CKJCommonTableViewCell *)cell;
- (UITableViewCellEditingStyle)tableView:(nonnull CKJSimpleTableView *)tableView editingStyleForRowAtIndexPath:(nonnull NSIndexPath *)indexPath section:(NSInteger)section row:(NSInteger)row model:(nonnull __kindof CKJCommonCellModel *)model cell:(nonnull __kindof CKJCommonTableViewCell *)cell;
