...
- (void)tableView:(UITableView *)tableView willDisplayCell:(CKJCommonTableViewCell *)cell forRowAtIndexPath:(NSIndexPath *)indexPath {
    NSInteger section = indexPath.section, row = indexPath.row;
...
//        if (cell.cornerLayer.opacity != 1) {
//            cell.cornerLayer.opacity = 1;
//        }
//        if (onlyView.layer.cornerRadius != cornerRadius) {
//            onlyView.layer.cornerRadius = cornerRadius;
//        }
//        if (onlyView.clipsToBounds != YES) {
//            onlyView.clipsToBounds = YES;
//        }
...
//        if (onlyView.layer.cornerRadius != 0) {
//            onlyView.layer.cornerRadius = 0;
//        }
//        if (onlyView.clipsToBounds != NO) {
//            onlyView.clipsToBounds = NO;
//        }
    }
}
...
- (NSMutableDictionary *)cell_Model_keyValues {
    ...
    NSDictionary *dic = @{
        ...
        NSStringFromClass([CKJImageViewCellModel class]) : @{cellKEY : NSStringFromClass([CKJImageViewCell class]), isRegisterNibKEY : @NO},
        NSStringFromClass([CKJOneBtnCellModel class]) : @{cellKEY : NSStringFromClass([CKJOneBtnCell class]), isRegisterNibKEY : @NO}
