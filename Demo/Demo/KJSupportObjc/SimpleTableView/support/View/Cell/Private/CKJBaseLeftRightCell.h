...
+ (instancetype)baseLeftRightCellWithCellHeight:(nullable NSNumber *)cellHeight cellModel_id:(nullable NSString *)cellModel_id detailSettingBlock:(nullable CKJBaseLeftRightCellModelRowBlock)detailSettingBlock didSelectRowBlock:(nullable CKJBaseLeftRightCellModelRowBlock)didSelectRowBlock;
