 ...
 */
@property (assign, nonatomic)         NSInteger kjwd_extension_Interger1;
@property (copy, nonatomic, nullable) NSString *kjwd_extension_String1;
@property (weak, nonatomic, nullable) id        kjwd_extension_weakObj1;

@property (strong, nonatomic, nullable) id kjwd_extension_Obj1;
...
- (BOOL)kjwd_removeObject:(nullable ObjectType)object;
...
@interface NSMutableDictionary<KeyType, ObjectType> (WDYHFCategory)

+ (instancetype)kjwd_dictionaryWithDictionary:(NSDictionary<KeyType, ObjectType> *_Nullable)dict;
...
/*
 比如
 self.btn1.kjwd_ex_block1 = ^(UIButton * _Nonnull _v, id  _Nonnull obj1) {
     [_v setTitle:obj1[@"txt"] forState:UIControlStateNormal];
     _v.kjwd_ex_Obj1 = obj1;
 };
 self.btn1.kjwd_ex_block1(self.btn1, @{ @"txt" : @"六个月", @"month" : @"6" });
 NSLog(@"%@   ", self.btn1.kjwd_ex_Obj1);
 */
@property (strong, nonatomic, nullable) void (^kjwd_ex_block1)(__kindof UIView *_v, id obj1);
