...
// runtime
- (void)setKjwd_extension_Interger1:(NSInteger)kjwd_extension_Interger1 {
    objc_setAssociatedObject(self, @"kjwd_extension_Interger1", @(kjwd_extension_Interger1), OBJC_ASSOCIATION_RETAIN_NONATOMIC);
}

- (NSInteger)kjwd_extension_Interger1 {
    NSNumber *res = objc_getAssociatedObject(self, @"kjwd_extension_Interger1");
    return res.intValue;
}

- (void)setKjwd_extension_String1:(NSString *)kjwd_extension_String1 {
    objc_setAssociatedObject(self, @"kjwd_extension_String1", kjwd_extension_String1, OBJC_ASSOCIATION_COPY_NONATOMIC);
}

- (NSString *)kjwd_extension_String1 {
    NSString *res = objc_getAssociatedObject(self, @"kjwd_extension_String1");
    return res;
}

- (void)setKjwd_extension_weakObj1:(id)kjwd_extension_weakObj1 {
    objc_setAssociatedObject(self, @"kjwd_extension_weakObj1", kjwd_extension_weakObj1, OBJC_ASSOCIATION_ASSIGN);
}
- (id)kjwd_extension_weakObj1 {
    id res = objc_getAssociatedObject(self, @"kjwd_extension_weakObj1");
    return res;
}

- (void)setKjwd_extension_Obj1:(id)kjwd_extension_Obj1 {
    objc_setAssociatedObject(self, @"kjwd_extension_Obj1", kjwd_extension_Obj1, OBJC_ASSOCIATION_RETAIN_NONATOMIC);
}
- (id)kjwd_extension_Obj1 {
    id res = objc_getAssociatedObject(self, @"kjwd_extension_Obj1");
    return res;
}
...
- (BOOL)kjwd_removeObject:(id)object {
    if (object == nil || [object isKindOfClass:[NSNull class]]) {
        NSLog(@"kjwd_removeObject 对象不能被删除 因为对象为空");
        return NO;
    } else {
...
@implementation NSMutableDictionary (WDYHFCategory)

+ (instancetype)kjwd_dictionaryWithDictionary:(NSDictionary *)dict {
...
+ (instancetype)kjwd_alertTitle:(NSString *_Nullable)alertTitle message:(NSString *_Nullable)message alertAction_Left:(NSString *_Nullable)leftActionTitle leftBlock:(void(^_Nullable)(__weak UIAlertController *a))leftBlock right:(NSString *_Nullable)rightActionTitle rightBlock:(void(^_Nullable)(__weak UIAlertController *a))rightBlock detail:(void(^)(__weak UIAlertController *a))detail presentingVC:(UIViewController *_Nullable)presentingVC {
    ...
    if (presentingVC == nil) {
        presentingVC = [UIWindow kjwd_appdelegateWindow].rootViewController;
    }
    if (detail) {
        detail(alert);
    }
...
+ (instancetype)kjwd_alertTitle:(NSString *_Nullable)alertTitle message:(NSString *_Nullable)message actionSheet_top:(NSString *_Nullable)topSheetTitle topBlock:(void(^_Nullable)(__weak UIAlertController *a))topBlock centerSheet:(NSString *_Nullable)centerSheetTitle centerBlock:(void(^_Nullable)(__weak UIAlertController *a))centerBlock buttomSheet:(NSString *_Nullable)buttomSheetTitle buttomBlock:(void(^_Nullable)(__weak UIAlertController *a))buttomBlock detail:(void(^)(__weak UIAlertController *a))detail presentingVC:(UIViewController *_Nullable)presentingVC {
...
- (void)kjwd_removeVC:(UIViewController *)vc animated:(BOOL)animated {
    if ([vc isKindOfClass:[UIViewController class]]) {
        NSMutableArray *vcs = [NSMutableArray kjwd_arrayWithArray:self.viewControllers];
        [vcs kjwd_removeObject:vc];
...
// 附加
- (void)setKjwd_ex_Obj1:(id)kjwd_ex_Obj1 {
    objc_setAssociatedObject(self, @"kjwd_ex_Obj1", kjwd_ex_Obj1, OBJC_ASSOCIATION_RETAIN_NONATOMIC);
}
- (id)kjwd_ex_Obj1 {
    id ex_Obj1 = objc_getAssociatedObject(self, @"kjwd_ex_Obj1");
    return ex_Obj1;
}

- (void)setKjwd_ex_block1:(void (^)(__kindof UIView * _Nonnull, id _Nonnull))kjwd_ex_block1 {
    objc_setAssociatedObject(self, @"kjwd_ex_block1", kjwd_ex_block1, OBJC_ASSOCIATION_COPY_NONATOMIC);
}
- (void (^)(__kindof UIView * _Nonnull, id _Nonnull))kjwd_ex_block1 {
    void (^temp)(UIView *, id) = objc_getAssociatedObject(self, @"kjwd_ex_block1");
    return temp;
}
...
- (NSDate *)kjwd_nextyear {
    NSDate *date = [self kjwd_getDateByOffsetMonth:12];
    return date;
}
/** 去年 */
...
/// 获取月份偏移日期
- (NSDate *)kjwd_getDateByOffsetMonth:(NSInteger)month {
